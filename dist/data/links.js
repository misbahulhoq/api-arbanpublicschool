"use strict";
/**
 * This module is responsible for storing important links used throughout the application.
 * It provides a centralized place to manage and update links, making it easy to maintain
 * consistency and ensure that all components have access to the same URLs.
 *
 * The main functionalities provided by this module include:
 * - Storing key URLs that are frequently used by various parts of the application
 * - Allowing for easy updates to links without needing to change multiple files
 * - Serving as a single source of truth for all important application links
 *
 * This module is intended to be used by components that require access to specific links
 * and should be imported wherever those links are needed.
 *
 * @module ImportantLinks
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.importantLinks = void 0;
exports.importantLinks = `
